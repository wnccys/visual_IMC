...
outro ponto eh q eu tive um problemao com a execuçao ja q ficava aparecendo um erro de objeto que era justamente a funçao de limpartela() que no console de debug aparentemente, tirei, parou;